...
FacebookMessengerClient.prototype.receivedPostback = function (bot, event) {
  var session = new Session(bot, event.sender.id, this);
  // pass the whole event
  bot.trigger('postback_received', event, session);
}
